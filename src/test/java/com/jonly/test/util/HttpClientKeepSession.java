/**
 * <p>项目名称：jlcj
 * <p>Package名称：com.changx.jlcj.util
 * 文件名称：HttpClientKeepSession.java 
 * 版本：1.00 
 * 创建日期：2018年10月8日
 * Copyright©2007 长信畅中.All Rights Reserved.
 */
...
public class HttpClientKeepSession {
    ...
    public static void main(String[] args) throws ClientProtocolException, IOException {
        // 用户登陆
//        CloseableHttpResponse response = HttpClientKeepSession.post("http://localhost:8080/BCP/j_spring_security_check",
//                "j_username=13301330133&j_password=330133");
        addCookie("JSESSIONID", "A2A570B352089FCA4BA2AEADD8BCEDF2", "172.16.0.142", "/CGW/");
        CloseableHttpResponse response = HttpClientKeepSession.get("http://172.16.0.142:6200/CGW/index.html");
